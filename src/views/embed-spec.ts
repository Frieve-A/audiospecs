        ...
        try {
          ...
          if (narration.bandNarrations.length > 0) {
            ...
            for (const b of narration.bandNarrations) {
              ...
              html += `<span class="fr-band-value"><span class="fr-gauge-wrap"><span class="fr-gauge-bar ${dirClass} fr-bar-sev-${b.severity}" style="${barStyle}"></span>${GAUGE_SVG}</span><span class="fr-band-num">${esc(db)}</span></span>`;
