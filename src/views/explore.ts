...
const DEFAULT_NUMERIC_KEYS = [
  'price_anchor_usd', 'release_year', 'perf_sinad_db', 'perf_thd_percent',
  'spec_impedance_ohm', 'driveability_index', 'spec_freq_low_hz', 'spec_freq_high_hz',
];
  ...
  container.innerHTML = `
    ...
    <div class="controls-bar">
      ...
      <div class="control-group" style="display:flex;align-items:flex-end;margin-left:auto">
        <button id="explore-reset">${t('common.reset')}</button>
      </div>
    </div>
      ...
      ? rows
          ...
          <tr>
            ...
            <td class="search-icons">
              ...
              <button class="search-amazon" data-brand="${escHtml(String(r.brand_label || ''))}" data-name="${escHtml(String(r.product_name || ''))}" title="Amazon">
