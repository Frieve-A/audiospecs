...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'explore.col.perf_preference_score': 'Pref Score',
    'explore.col.perf_preference_score_with_sub': 'Pref Score\n(w/ Sub)',
    'explore.col.perf_preference_score_eq': 'Pref Score\n(EQ)',
    'explore.col.perf_preference_score_eq_with_sub': 'Pref Score\n(EQ+Sub)',
    ...
    'compare.field.perf_preference_score': 'Preference Score',
    'compare.field.perf_preference_score_with_sub': 'Pref Score (w/ Sub)',
    'compare.field.perf_preference_score_eq': 'Pref Score (EQ)',
    'compare.field.perf_preference_score_eq_with_sub': 'Pref Score (EQ + Sub)',
    ...
    'axis.perf_preference_score': 'Preference Score',
    'axis.perf_preference_score_with_sub': 'Pref Score (w/ Sub)',
    'axis.perf_preference_score_eq': 'Pref Score (EQ)',
    'axis.perf_preference_score_eq_with_sub': 'Pref Score (EQ + Sub)',
    ...
    'axisdesc.perf_preference_score': 'Spinorama Preference Score (no subwoofer, no EQ). Higher is better — derived from speaker Spinorama measurements.',
    'axisdesc.perf_preference_score_with_sub': 'Spinorama Preference Score with subwoofer. Higher is better — accounts for subwoofer bass extension.',
    'axisdesc.perf_preference_score_eq': 'Spinorama Preference Score with EQ applied (no subwoofer). Higher is better — shows potential improvement from EQ.',
    'axisdesc.perf_preference_score_eq_with_sub': 'Spinorama Preference Score with EQ and subwoofer. Higher is better — best-case scenario with both EQ and sub.',
  ...
  ja: {
    ...
    'compare.field.perf_preference_score': 'Preference Score',
    'compare.field.perf_preference_score_with_sub': 'Pref Score (サブあり)',
    'compare.field.perf_preference_score_eq': 'Pref Score (EQ)',
    'compare.field.perf_preference_score_eq_with_sub': 'Pref Score (EQ+サブ)',
    ...
    'axis.perf_preference_score': 'Preference Score',
    'axis.perf_preference_score_with_sub': 'Pref Score (サブあり)',
    'axis.perf_preference_score_eq': 'Pref Score (EQ)',
    'axis.perf_preference_score_eq_with_sub': 'Pref Score (EQ+サブ)',
    ...
    'axisdesc.perf_preference_score': 'Spinorama Preference Score（サブなし・EQなし）。高いほど良好 — Spinorama測定に基づくスピーカー評価指標です。',
    'axisdesc.perf_preference_score_with_sub': 'Spinorama Preference Score（サブあり）。高いほど良好 — サブウーファーによる低域拡張を考慮しています。',
    'axisdesc.perf_preference_score_eq': 'Spinorama Preference Score（EQあり・サブなし）。高いほど良好 — EQ適用による改善の可能性を示します。',
    'axisdesc.perf_preference_score_eq_with_sub': 'Spinorama Preference Score（EQ+サブ）。高いほど良好 — EQとサブウーファーの両方を適用したベストケースです。',
